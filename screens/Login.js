import { View, Text, TextInput, TouchableOpacity, Alert, StyleSheet, Dimensions, Image, Pressable } from "react-native";
...
export default function Login({ navigation }) {
  ...
  return (
    <LinearGradient style={styles.container} colors={["#432F92", "#F7A906"]}
    start={{ x: 2, y: 0 }}
    end={{ x: 2, y: 0.6 }}>
      <View style={styles.topContainer}>
        <Text style={styles.welcomeText}>Welcome Agent</Text>
        <Image source={require("../assets/login-image.png")} style={styles.logo} />
      </View>
