...
const AddLead = ({ route, navigation }) => {
    ...
    const handleAddLead = async () => {
        setIsLoading(true);
        const baseUrl = selectedTicket === 'chit' ? `http://13.53.131.163:3000/api` : 'http://13.60.68.201:3000/api';

        if (!customerInfo.full_name || !customerInfo.phone_number || !selectedTicket || !selectedGroup) {
                    ...
                    <View style={{ marginHorizontal: 22, marginTop: 12, flex: 1 }}>
                        ...
                        <View style={styles.container}>
                            <View style={styles.contentContainer}>
                                ...
                                />
                                <Text style={{ fontWeight: "bold", marginTop: 10 }}>Work/Profession</Text>
                                ...
                                <Text style={{ fontWeight: "bold", marginTop: 10 }}>Scheme Type</Text>
                                <View style={styles.pickerContainer}>
                                    <Picker
                                ...
                                <View style={styles.pickerContainer}>
                                    ...
                                    >
                                        ...
                                        {groups.map((group, index) => (
                                            <Picker.Item key={index} label={group.group_name} value={group._id} />
                                        ))}
                                    </Picker>
                                </View>
                                {additionalInfo !== "" && (
